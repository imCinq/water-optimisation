...
public final class FluidOptimizationPolicy {
	...
	/**
	 * 1.21.11 has a different fluid renderer and no reviewed Sodium geometry
	...
	/**
	 * The 1.21.11 renderer does not expose the already-read neighbor locals in a
	...
	private static boolean hidesFluidFace(BlockState blockState, FluidState fluidState) {
		// The 1.21.11 solid-render query requires a level and position. Do not
