# Water Optimisation 0.0.10-26.3-preview.2 — PREVIEW

This is an **unpublished Fabric 26.3 preview**, not a stable release or an extension of the public 0.0.9 support matrix. No NeoForge 26.3 artifact is provided. No in-game tests were run for this hardening; CI is pending, and visual correctness and FPS benefits are not validated.
...
- Runtime artifact target: `build/26.3/libs/water-optimisation-0.0.10-26.3-preview.2-mc26.3-fabric.jar`.

Use the runtime JAR, not the sources JAR, in an isolated matching client. Build and launch instructions are in the [Fabric 26.3 preview guide](FABRIC_26_3.md). The preview does not replace existing 0.0.9 artifacts.
...
Water Optimisation remains client-only: no fluid simulation, gameplay, movement, collision, networking, or server-state changes are intended. This preview carries no stable-support, server-approval, or publication claim.
